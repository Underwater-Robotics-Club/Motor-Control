...
// Sequence 1
      ...
      digitalWrite(26, HIGH); //Establishes forward direction of Channel B
      digitalWrite(28, LOW);   //Disengage the Brake for Channel B
      analogWrite(S1CB, 255);

      digitalWrite(22, HIGH); //Establishes forward direction of Channel A
      digitalWrite(24, LOW);   //Disengage the Brake for Channel A
...
// Sequence 2
      ...
      digitalWrite(32, LOW);   //Disengage the Brake for Channel A
